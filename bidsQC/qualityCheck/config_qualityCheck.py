...
path_bidsdata = os.path.join(os.sep, 'home', 'eberger', 'projects', "bidsTutorial", 'bids_data')  # Where your subjects' nifti directories are
...
sequence2 = Sequence('func', {'bart': 1, 'gng1':1, 'gng2':1, 'react1':1, 'react2':1, 'sst1':1, 'sst2':1})
...
timepoint2 = TimePoint('ses-wave2', [sequence1, sequence3, sequence4])  # Add as many timepoints as needed and fill it with the correct sequences
