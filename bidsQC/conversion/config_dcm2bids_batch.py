...
singularity_image = "dcm2bids_2022-1-18.sif" # ignored if running locally; dcm2bids singularity image name
...
path_toplevel = os.path.join(os.sep, "home", "eberger", "projects", "bidsTutorial") # folder that contains path_bidsdata and path_conversionfolder
...
singularity_image = os.path.join(os.sep, "home", "eberger", "projects", "containers", singularity_image) # Set equal to "NA" if you are running the script locally
...
path_bidsdata = os.path.join(os.sep, "home", "eberger", "projects", "bidsTutorial", "bids_data") # Where the niftis will be put
